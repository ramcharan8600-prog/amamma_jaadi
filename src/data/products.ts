...
export const PICKUP_LOCATIONS: PickupLocation[] = [
  ...
  {
    id: 'irving-biryanify',
    name: 'Biryanify - Irving',
    address: '9400 N MacArthur Blvd #150',
    city: 'Irving',
    state: 'TX',
    zip: '75063',
  },
  {
    id: 'frisco-ravibabu',
    name: 'Ravi Babu Biryani - Frisco',
    address: '6226 All Stars Ave',
    city: 'Frisco',
    state: 'TX',
    zip: '75033',
  },
  {
    id: 'irving-ravibabu',
    name: 'Ravi Babu Biryani - Irving',
    address: '8505 Walton Blvd',
    city: 'Irving',
    state: 'TX',
    zip: '75063',
  },
