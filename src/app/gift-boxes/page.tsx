...
export const metadata: Metadata = {
  title: 'Premium Gift Boxes — Luxury Indian Sweet Gifting',
  description:
    'Premium aluminium tin gift boxes filled with authentic South Indian sweets. Perfect for festivals, birthdays, celebrations & corporate gifting. $50 flat price.',
};
