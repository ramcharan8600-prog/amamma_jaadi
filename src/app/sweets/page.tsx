...
export const metadata: Metadata = {
  ...
  description:
    'Order fresh Bobbatlu, Kova Bobbatlu, Malai Khaja, Kova, Guntur Malpuri & an Assorted Box. Made daily with pure ghee, A2 milk & organic ingredients. Pickup or delivery in Dallas, TX.',
